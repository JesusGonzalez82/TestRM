        ...
        function eresMadridista(){
            ...
            if (respuestas.A === maxRespuesta){
                ...
                document.getElementById('consejo').innerHTML = "Consejo: Intenta disfrutar un poco más del equipo y de la vida en general";
            }
            if (respuestas.B === maxRespuesta) {
                ...
                document.getElementById('consejo').innerHTML = "Consejo: Intenta hacer un poco de autocrítica, no todo es maravilloso.";
            }
            if (respuestas.C === maxRespuesta) {
                ...
                document.getElementById('consejo').innerHTML = "Consejo: Trate de elevar su nivel de exigencia y no se conforme solo con disfrutar sin importar el rendimiento del equipo";
            }
            if (respuestas.D === maxRespuesta) {
                ...
                document.getElementById('consejo').innerHTML = "Consejo: Sigue manteniendo el equilibrio entre pasión y objetividad";
            }
            // En caso de empate
            if (maxCount > 1){
                ...
                document.getElementById('consejo').innerHTML = "Consejo: Es importante reflexionar sobre lo que realmente valoras del equipo. No dejes que las emociones del momento te lleven a tener una actitud fluctuante. Encuentra tu equilibrio y sé consistente en tu apoyo.";
            }
        }
